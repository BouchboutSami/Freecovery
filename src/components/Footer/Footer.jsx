...
const Footer = () => {
  return (
    <footer className="text-center bg-yellowIWD text-[black] border-t-4 justify-self-end flex w-screen opacity-75">
      <div className="pt-6">
        ...
        <div className="mb-6">
          <p className="px-[10%]">
            we made it a priority to promote our website and resources to
            underserved communities and raise awareness about the importance of
            addiction recovery. We reached out to local organizations and
            community leaders to spread the word and build a network of support
            for those in need.
          </p>
        </div>
      </div>
